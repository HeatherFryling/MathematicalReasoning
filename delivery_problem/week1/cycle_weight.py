# Heather Fryling
# 5/22/2020
# Coursera Delivery Problem Class
# Function to return the weight of a Hamiltonian cycle.
...
def cycle_length(g, cycle):
    ...
    for i in range(len(cycle) - 1):
        weight += g[cycle[i]][cycle[i+1]][weight_key]
    weight += g[cycle[-1]][cycle[0]][weight_key]
    return weight
